...
const testimonials = [{
        name: "Viezh, Robert",
        profile_pic_path: "Image/Review/Ellipse1.png",
        location: "Warsaw, Poland",
        rating: "4.5",
        message: "Wow... I am very happy with this MaxCX service. It turned out to be more than my expectations and so far there have been no problems. MaxCX always the best",
    },
    {
        name: "Yessica, Christy",
        profile_pic_path: "Image/Review/Ellipse2.png",
        location: "Shanxi, China",
        rating: "4.5",
        message: "I like it because I've my userbase around the globe and MaxCX just makes it a lot easier for me removing all the inter-continent barriers",
    },
    {
        name: "Kim Young, Jou",
        profile_pic_path: "Image/Review/Ellipse3.png",
        location: "Seoul, South Korea",
        rating: "4.5",
        message: "“This is very unusual for my business that currently requires a partner that keeps my data at the highest possibe security”.",
    },
]
...
document.querySelector(".slider-button.right").onclick = () => {
    let index =
        selectedIndex === testimonialItemsList.length - 1 ? 0 : selectedIndex + 1
    selectTestimonial(index)
}

document.querySelector(".slider-button.left").onclick = () => {
    let index =
